...
type CampData = {
  id: string;
  name: string;
  location: "north_gaza" | "gaza_city" | "middle_area" | "khan_yunis" | "rafah";
  capacity: number;
  operationalStatus: string;
  needLevel: string;
  notes: string | null;
  status: string;
  assignedManagers: string[]; // array of userIds
};
...
export default function EditCampForm({
  ...
  const [form, setForm] = useState({
    ...
    needLevel: camp.needLevel as "low" | "medium" | "high" | "critical",
    operationalStatus: camp.operationalStatus as "active" | "inactive" | "closed",
    notes: camp.notes ?? "",
    assignedManagers: camp.assignedManagers || [], // array of userIds
  });

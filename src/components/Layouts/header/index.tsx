  ...
  return (
    <header className="border-stroke shadow-1 dark:border-stroke-dark dark:bg-gray-dark sticky top-0 z-30 flex items-center justify-between border-b bg-white px-4 py-5 md:px-5 2xl:px-10">
      ...
      <div className="max-xl:hidden">
        ...
        <p className="font-medium text-xs text-dark-5 dark:text-dark-6">Sa3dne Camp Management</p>
      </div>
      ...
      <div className="2xsm:gap-4 flex flex-1 items-center justify-end gap-2">
        ...
        <button
          ...
          className="dark:border-stroke-dark dark:bg-dark-2 dark:hover:bg-dark-3 flex h-10 w-10 min-w-10 min-h-10 shrink-0 items-center justify-center rounded-full border border-stroke bg-gray-2 text-xs font-bold text-dark hover:bg-gray-3 whitespace-nowrap dark:text-white"
